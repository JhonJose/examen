...
class Preguntas{
    public function cuestionario(){
        ...
        echo "<tr><th>N.</th><th><center>Preguntas</center></th><th><center>Respuestas</center></th>";

       $sql=" SELECT * FROM examen.preguntas ORDER BY rand() LIMIT 10;";
        ...
        while($p=mysql_fetch_array($consulta)){
            ...
            $consulta02=mysql_query($sql02) or die ("Error al consultar: $sql02");
            ...
            $ID_R=mysql_result($consulta02,$y,'ID_Respuesta');
                ...
                $consulta03=mysql_query($sql03) or die ("Error al consultar: $sql03");
